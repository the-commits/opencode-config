...
- **Config file**: This project uses `opencode.jsonc` ONLY. Never create or use `opencode.json`. If an external installer creates `opencode.json`, merge its contents into `opencode.jsonc` and delete `opencode.json` immediately.
