...
319 tests across 19 modules covering the supply chain guard, PHP tooling, personal instructions, and the shared `resolveConfigDir` utility. Pure, fast, no external dependencies.
